...
/*Search Function for City Input*/
function searchCity(cityname) {
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + cityname + "&units=imperial&appid=440fa4ddb1d197c5830cad2434552bf1";
    var queryURLforcast = "https://api.openweathermap.org/data/2.5/forecast?q=" + cityname + "&units=imperial&appid=440fa4ddb1d197c5830cad2434552bf1";
    ...
    $.ajax({
       ...
       var mainDate = moment().format('L');
        ...
        /*Creates HTML for city's weather*/
        ...
        /*Creates div to append information to page*/
        var newDiv = $("<div>");
...
/*Call for UV information*/
var lat = response.coord.lat;
var lon = response.coord.lon;
var queryURLUV = "https://api.openweathermap.org/data/2.5/uvi?&appid=440fa4ddb1d197c5830cad2434552bf1&lat=" + lat  + "&lon=" + lon;
...
/*Store results array*/
    ...
    /*Clear future forecast*/
    $("#fiveDay").empty();
    /*Appends five day forecast*/
    ...
    /*Create divs*/
        ...
        /*Creates date, temperature, and humidity information for future card forecast*/
...
$("#selectCity").on("click", function (event) {
    ...
    /*Store City*/
    var cityInput = $("#enterCity").val().trim();
